...
import br.com.great.gcm.server.Constants;
import br.com.great.gcm.server.InvalidRequestException;
import br.com.great.gcm.server.Message;
import br.com.great.gcm.server.MulticastResult;
import br.com.great.gcm.server.Result;
import static br.com.great.gcm.server.Constants.GCM_SEND_ENDPOINT;
import static br.com.great.gcm.server.Constants.JSON_CANONICAL_IDS;
import static br.com.great.gcm.server.Constants.JSON_ERROR;
import static br.com.great.gcm.server.Constants.JSON_FAILURE;
import static br.com.great.gcm.server.Constants.JSON_MESSAGE_ID;
import static br.com.great.gcm.server.Constants.JSON_MULTICAST_ID;
import static br.com.great.gcm.server.Constants.JSON_PAYLOAD;
import static br.com.great.gcm.server.Constants.JSON_REGISTRATION_IDS;
import static br.com.great.gcm.server.Constants.JSON_RESULTS;
import static br.com.great.gcm.server.Constants.JSON_SUCCESS;
import static br.com.great.gcm.server.Constants.PARAM_COLLAPSE_KEY;
import static br.com.great.gcm.server.Constants.PARAM_DELAY_WHILE_IDLE;
import static br.com.great.gcm.server.Constants.PARAM_PAYLOAD_PREFIX;
import static br.com.great.gcm.server.Constants.PARAM_REGISTRATION_ID;
import static br.com.great.gcm.server.Constants.PARAM_TIME_TO_LIVE;
import static br.com.great.gcm.server.Constants.TOKEN_CANONICAL_REG_ID;
import static br.com.great.gcm.server.Constants.TOKEN_ERROR;
import static br.com.great.gcm.server.Constants.TOKEN_MESSAGE_ID;
import br.com.great.gcm.server.Result.Builder;
